...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        boolean statusVenda = produtosdao.venderProduto(Integer.parseInt(id));

        if (statusVenda == true) {
            JOptionPane.showMessageDialog(null, "Produto marcado como vendido com sucesso!");
        }
        else {
            JOptionPane.showMessageDialog(null, "Produto não encontrado na base de dados, informe o id correto");
        }
        listarProdutos();
